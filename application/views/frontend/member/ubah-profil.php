...
<div class="container mt-3">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <?php echo form_open_multipart('member/ubahProfil/'); ?>
            <div class="form-group row">
                <label for="email" class="col-sm-2 col-form-label" id="email">Email</label>
                <div class="col-sm-10">
                    <input type="text" value="<?= $pelanggan['id_pelanggan']; ?>" name="id_pelanggan" hidden="hidden">
                    <input type="text" class="form-control" value="<?= $pelanggan['email']; ?>" readonly="" name="email">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group">
                ...
                <a href="<?= base_url('member/myProfil'); ?>" class="btn btn-secondary">Kembali</a>
            </div>
            </form>
        </div>
    </div>
