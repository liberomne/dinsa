...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="<?= base_url('home/') ?>"><img
                    src="<?= base_url('assets/img/logo/dinsalogo.png') ?>" width="250px"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ml-auto">
                    ...
                    <?php if ($judul == 'Dinsa Laundry | Home') : ?>
                        <li class="nav-item">
                            <a class="nav-link active mr-3" href="<?= base_url('home/'); ?>"><b>Beranda</b></a>
                        </li>
                    <?php else : ?>
                        <li class="nav-item">
                    ...
                    if (!empty($this->session->userdata('email'))) { ?>
                        <?php if ($judul == 'Keranjang Anda | Dinsa Laundry') : ?>
                            <li class="nav-item">
                                <a class="nav-link active mr-3" href="<?= base_url('keranjang/'); ?>"><b><i class="fas fa-shopping-basket"></i> 
                                <?php 
                                    $notif_keranjang = $this->session->userdata('notif_keranjang'); 
                                    echo $notif_keranjang ? $notif_keranjang : 0;
                                ?>
                                </b></a>
                            </li>
                        <?php else : ?>
                            <li class="nav-item">
                                <a class="nav-link mr-3" href="<?= base_url('keranjang/'); ?>"><i class="fas fa-shopping-basket"></i> 
                                <?php 
                                    $notif_keranjang = $this->session->userdata('notif_keranjang'); 
                                    echo $notif_keranjang ? $notif_keranjang : 0;
                                ?></a>
                        ...
                        <!-- <li class="nav-item">
                            <a class="nav-link" href="<?= base_url('cek_pemesanan'); ?>">Cek Pemesanan</a>
                        </li> -->
                        ...
                        <li class="nav-item dropdown">
                            <a class="btn btn-secondary dropdown-toggle mt-2" href="#" id="navbarDropdownMenuLink"
                    ...
                    <?php } else { ?>
                        <li class="nav-item dropdown">
                            <a class="btn btn-secondary dropdown-toggle mt-2" href="#" id="navbarDropdownMenuLink"
                                role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Pengunjung
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
    ...
    <header class="masthead">
        <div class="container">
            <div class="intro-text">
                ...
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#services">Pesan
                    Laundry</a>
            </div>
        </div>
    </header>